...
<form action="<?php echo URL; ?>post/new_post" method="post" id="post_form" onsubmit="post_data();return false;">
  ...
  <fieldset>
	 ...
	 <div id="FilterDiv">
<label for="foo">If you are human then leave this field empty</label>
<input type="text" name="post[c4vgbh]" id="yhy6myu">
</div>
<script>
(function () {
 jQuery("#FilterDiv").children().hide();
})();
</script>
...
jQuery("#post_textareadiv").text(500-this.value.length+' chars remaining');
}
});
</script>
<?}else{?>
